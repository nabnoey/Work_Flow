      ...
      <div className="bg-green-50 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed">
            จากความตั้งใจจริงที่จะปลูกผัก ผลไม้ปลอดภัย
            รสชาติอร่อยและมีคุณภาพสูงและการเพาะปลูกที่เน้นความปลอดภัยต่อผู้บริโภคและใส่ใจในสิ่งแวดล้อม
            ...
            {/* ตัดข้อความเพื่อความกระชับ สามารถเติมได้ตามต้องการ */}
          </p>
        </div>
      </div>
